...
func main() {
	...
	initLogger()
	go initTracing()
	go initProfiling("arrayparse", "1.0.0")
	...
	svc := new(arrayParseServiceServer)
	pb.RegisterArrayParseServiceServer(srv, svc)
...
func (ap *arrayParseServiceServer) Check(ctx context.Context, r *healthpb.HealthCheckRequest) (*healthpb.HealthCheckResponse, error) {
	return &healthpb.HealthCheckResponse{
		Status: healthpb.HealthCheckResponse_SERVING,
	}, nil
}

func (ap *arrayParseServiceServer) Watch(r *healthpb.HealthCheckRequest, _ healthpb.Health_WatchServer) error {
	return nil
}
